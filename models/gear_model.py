...
functions = [
    {  # evaluate speed/velocity ratios
       'function': evaluate_speed2velocity_ratios_v0,
       'inputs': ['gear_box_ratios', 'final_drive', 'R_dynamic'],
       'outputs': ['speed_velocity_ratios'],
    },
    {  # evaluate speed/velocity ratios
       'function': identify_speed2velocity_ratios_v1,
    ...
    {  # gear prediction with decision tree V.A.
       'function': gear_shifting_prediction_decision_tree,
    ...
    {  # gear prediction with MPV
       'function': gear_shifting_prediction_cmpv,
    ...
    {  # gear prediction with MPV Hot/Cold
       'function': gear_shifting_prediction_cmpv_hot_cold,
