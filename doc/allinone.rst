   ...
   output is quasi-similar:
        ...
        - In *command-prompt*, type:
          ...
          .. code-block:: console
            ...
            > where python
            D:\co2mpas_ALLINONE-64bit-v1.3.1b1\Apps\WinPython-64bit-3.4.3.5\python-3.4.3\python.exe
            D:\co2mpas_ALLINONE-64bit-v1.3.1b1\Apps\Cygwin\bin\python

            > co2mpas --version
            co2mpas-1.3.1b1 at D:\co2mpas_ALLINONE-64bit-v1.3.1b1\Apps\WinPython-64bit-3.4.3.5\python-3.4.3\lib\site-packages\co2mpas
        ...
        - In *bash*, type:
          ...
          .. code-block:: console
            ...
            > which python
            /cygdrive/d/co2mpas_ALLINONE-64bit-v1.3.1b1/Apps/WinPython-64bit-3.4.3.5/python-3.4.3/python
