...
from co2mpas import _prediction_WLTP
...
def load_inputs():
    ...
    load_inputs.add_function(
        ...
        outputs=['nedc_inputs', 'prediction_nedc_cycle_targets'],
    )
