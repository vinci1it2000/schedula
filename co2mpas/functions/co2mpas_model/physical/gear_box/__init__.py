...
.. currentmodule:: co2mpas.functions.co2mpas_model.physical.gear_box
...
from co2mpas.functions.co2mpas_model.physical.utils import bin_split, \
    reject_outliers
...
def calculate_gear_box_efficiencies_torques_temperatures(
    ...
    from co2mpas.models.co2mpas_model.physical.gear_box.thermal import thermal
