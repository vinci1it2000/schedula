...
def _param_orders():
    _map = {
        ...
        'fuel_consumption_UDC': 'fuel_consumption 1',
        'fuel_consumption_EUDC': 'fuel_consumption 2',
        'fuel_consumption_low': 'fuel_consumption 1',
        'fuel_consumption_medium': 'fuel_consumption 2',
        'fuel_consumption_high': 'fuel_consumption 3',
        'fuel_consumption_extra_high': 'fuel_consumption 4',
        'target': '1',
        'prediction': '2',
        'calibration': '4',
        'theoretic': '3',
        ...
        'mean_piston_speed': 'willans 04',
        'fuel_mep': 'willans 05',
        'fuel_consumption': 'willans 06',
        'willans_a': 'willans 07',
        'willans_b': 'willans 08',
        'specific_fuel_consumption': 'willans 09',
