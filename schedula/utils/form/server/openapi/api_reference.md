...
- **Flask-Security** registra anche endpoint interni non presenti nel codice di questa repo: li elenco in un blocco
  dedicato.
...
**Nota**: i path possono variare leggermente in base alla versione di Flask-Security(-Too) installata e alla
configurazione; qui trovi l’elenco *completo e tipico* per le feature abilitate.
