...
export const locale = merge({}, en, {
    ...
    Cookies: {
        ...
        settingsIntro: "The options provided in this section allow you to customize your consent preferences for any tracking technology used for the purposes described below. To learn more about how these trackers help us and how they work, refer to the [cookie policy](/gdpr/files/cookies-policy). Please be aware that denying consent for a particular purpose may make related features unavailable.",
        introText: "We and selected third parties use cookies or similar technologies for technical purposes and, with your consent, for other purposes as specified in the Cookie Policy. For more information read our [Terms and Conditions](/gdpr/files/terms-conditions) and [Cookie Policy](/gdpr/files/cookies-policy).",
